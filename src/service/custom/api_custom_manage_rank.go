...
// /api/custom/manage/rank Service 后台获取排名
func ApiCustomManageRankService(
    user *master_types.User,
    GameId master_types.PrimaryId,
    Page int,
    PageSize int,
) (*master_types.MasterResponse) {
    var apiCustomManageRankResponse struct {
...
/* @MT-TPL-SERVICE-END */
    ...
    return master_types.SuccessResponse(apiCustomManageRankResponse)
}
