...
// /api/custom/attacker/self Service 获取红队自身信息
func ApiCustomAttackerSelfService(
	user *master_types.User,
	GameId master_types.PrimaryId,
) *master_types.MasterResponse {
	var apiCustomAttackerSelfResponse struct {
		Team *master_types.RedTeam `json:"team"`
	}
...

	{
		...
		apiCustomAttackerSelfResponse.Team = value
	}
	/* @MT-TPL-SERVICE-END */
	...
	return master_types.SuccessResponse(apiCustomAttackerSelfResponse)
}
