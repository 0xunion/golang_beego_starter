...
// /api/custom/manage/rank/blue_team Service 后台获取排名
func ApiCustomManageRankBlueTeamService(
    user *master_types.User,
    GameId master_types.PrimaryId,
    Page int,
    PageSize int,
) (*master_types.MasterResponse) {
    var apiCustomManageRankBlueTeamResponse struct {
...

    {
        ...
        apiCustomManageRankBlueTeamResponse.Rank = value
    }
/* @MT-TPL-SERVICE-END */
    ...
    return master_types.SuccessResponse(apiCustomManageRankBlueTeamResponse)
}
