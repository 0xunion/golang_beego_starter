...
// /api/custom/manage/trace_report/detail Service 裁判获取溯源报告详情
func ApiCustomManageTraceReportDetailService(
    user *master_types.User,
    GameId master_types.PrimaryId,
    ReportId master_types.PrimaryId,
) (*master_types.MasterResponse) {
    var apiCustomManageTraceReportDetailResponse struct {
...
value, err := model.ModelGet[master_types.TraceReport](
        ...
        apiCustomManageTraceReportDetailResponse.Report = value
    }
/* @MT-TPL-SERVICE-END */
    ...
    return master_types.SuccessResponse(apiCustomManageTraceReportDetailResponse)
}
