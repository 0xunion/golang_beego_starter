...
// /api/custom/admin/game/template/leader Service 生成领导模板文件
func ApiCustomAdminGameTemplateLeaderService(
    user *master_types.User,
    GameId master_types.PrimaryId,
) (*master_types.MasterResponse) {
    var apiCustomAdminGameTemplateLeaderResponse struct {
...
/* @MT-TPL-SERVICE-END */
	...
	apiCustomAdminGameTemplateLeaderResponse.FileId = id

	/* @MT-TPL-SERVICE-RESP-START */

    return master_types.SuccessResponse(apiCustomAdminGameTemplateLeaderResponse)
}
