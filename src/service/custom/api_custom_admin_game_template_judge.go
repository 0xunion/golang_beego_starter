...
// api/custom/admin/game/template/judge Service 生成裁判模板文件
...
/* @MT-TPL-SERVICE-END */
	...
	apiCustomAdminGameTemplateJudgeResponse.FileId = id

	/* @MT-TPL-SERVICE-RESP-START */

    return master_types.SuccessResponse(apiCustomAdminGameTemplateJudgeResponse)
}
