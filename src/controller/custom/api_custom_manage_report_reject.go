...
type ApiCustomManageReportRejectController struct {
    beego.Controller
}

func (c *ApiCustomManageReportRejectController) Post() {
    ...
    response := custom_service.ApiCustomManageReportRejectService(
        user,
