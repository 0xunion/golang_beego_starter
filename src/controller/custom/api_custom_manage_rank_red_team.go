...
type ApiCustomManageRankRedTeamController struct {
    beego.Controller
}

func (c *ApiCustomManageRankRedTeamController) Get() {
    ...
    response := custom_service.ApiCustomManageRankRedTeamService(
        user,
