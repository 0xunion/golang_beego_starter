...
type ApiCustomManageReportCommentController struct {
    beego.Controller
}

func (c *ApiCustomManageReportCommentController) Post() {
    ...
    response := custom_service.ApiCustomManageReportCommentService(
        user,
