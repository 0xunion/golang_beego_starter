...
type ApiCustomManageTraceReportDetailController struct {
    beego.Controller
}

func (c *ApiCustomManageTraceReportDetailController) Get() {
    ...
    response := custom_service.ApiCustomManageTraceReportDetailService(
        user,
