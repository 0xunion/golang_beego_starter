...
type ApiCustomManageReportDetailController struct {
    beego.Controller
}

func (c *ApiCustomManageReportDetailController) Get() {
    ...
    response := custom_service.ApiCustomManageReportDetailService(
        user,
