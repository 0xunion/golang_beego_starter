...
type ApiCustomDefenderStatisticsController struct {
    beego.Controller
}

func (c *ApiCustomDefenderStatisticsController) Get() {
    ...
    response := custom_service.ApiCustomDefenderStatisticsService(
        user,
