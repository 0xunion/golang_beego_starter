...
type ApiCustomDefenderAssetsListController struct {
    beego.Controller
}

func (c *ApiCustomDefenderAssetsListController) Get() {
    ...
    response := custom_service.ApiCustomDefenderAssetsListService(
        user,
