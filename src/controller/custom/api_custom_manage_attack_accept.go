...
type ApiCustomManageAttackAcceptController struct {
    beego.Controller
}

func (c *ApiCustomManageAttackAcceptController) Post() {
    ...
    response := custom_service.ApiCustomManageAttackAcceptService(
        user,
