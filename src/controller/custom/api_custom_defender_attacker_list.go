...
type ApiCustomDefenderAttackerListController struct {
    beego.Controller
}

func (c *ApiCustomDefenderAttackerListController) Get() {
    ...
    response := custom_service.ApiCustomDefenderAttackerListService(
        user,
