...
type ApiCustomDefenderReportListController struct {
    beego.Controller
}

func (c *ApiCustomDefenderReportListController) Get() {
    ...
    response := custom_service.ApiCustomDefenderReportListService(
        user,
