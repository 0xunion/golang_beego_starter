...
type ApiCustomAdminGameTemplatePartAController struct {
    beego.Controller
}

func (c *ApiCustomAdminGameTemplatePartAController) Get() {
    ...
    response := custom_service.ApiCustomAdminGameTemplatePartAService(
        user,
