...
type ApiCustomAdminGameImportJudgeController struct {
    beego.Controller
}

func (c *ApiCustomAdminGameImportJudgeController) Post() {
    ...
    response := custom_service.ApiCustomAdminGameImportJudgeService(
        user,
