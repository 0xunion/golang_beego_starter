...
type ApiCustomAttackerReportSectionController struct {
    beego.Controller
}

func (c *ApiCustomAttackerReportSectionController) Get() {
    ...
    response := custom_service.ApiCustomAttackerReportSectionService(
        user,
