...
type ApiCustomAdminGameTemplateDefenderController struct {
    beego.Controller
}

func (c *ApiCustomAdminGameTemplateDefenderController) Get() {
    ...
    response := custom_service.ApiCustomAdminGameTemplateDefenderService(
        user,
