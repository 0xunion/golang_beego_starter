...
type ApiCustomAttackerAttackDetailController struct {
    beego.Controller
}

func (c *ApiCustomAttackerAttackDetailController) Get() {
    ...
    response := custom_service.ApiCustomAttackerAttackDetailService(
        user,
