...
type ApiCustomManageTraceReportListController struct {
    beego.Controller
}

func (c *ApiCustomManageTraceReportListController) Get() {
    ...
    var request_params struct {
        ...
        State int64 `json:"state" form:"state" valid:""`
        Content string `json:"content" form:"content" valid:""`
    }
    ...
    response := custom_service.ApiCustomManageTraceReportListService(
        user,
