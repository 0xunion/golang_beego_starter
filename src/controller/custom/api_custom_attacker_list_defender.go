...
type ApiCustomAttackerListDefenderController struct {
    beego.Controller
}

func (c *ApiCustomAttackerListDefenderController) Get() {
    ...
    response := custom_service.ApiCustomAttackerListDefenderService(
        user,
