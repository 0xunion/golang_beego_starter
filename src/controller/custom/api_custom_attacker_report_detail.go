...
type ApiCustomAttackerReportDetailController struct {
    beego.Controller
}

func (c *ApiCustomAttackerReportDetailController) Get() {
    ...
    response := custom_service.ApiCustomAttackerReportDetailService(
        user,
