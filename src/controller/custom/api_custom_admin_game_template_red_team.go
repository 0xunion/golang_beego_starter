...
type ApiCustomAdminGameTemplateRedTeamController struct {
    beego.Controller
}

func (c *ApiCustomAdminGameTemplateRedTeamController) Get() {
    ...
    response := custom_service.ApiCustomAdminGameTemplateRedTeamService(
        user,
