...
type ApiCustomManageRankBlueTeamController struct {
    beego.Controller
}

func (c *ApiCustomManageRankBlueTeamController) Get() {
    ...
    response := custom_service.ApiCustomManageRankBlueTeamService(
        user,
