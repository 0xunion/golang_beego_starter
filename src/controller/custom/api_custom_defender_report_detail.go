...
type ApiCustomDefenderReportDetailController struct {
    beego.Controller
}

func (c *ApiCustomDefenderReportDetailController) Get() {
    ...
    response := custom_service.ApiCustomDefenderReportDetailService(
        user,
