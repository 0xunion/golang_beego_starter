...
type ApiCustomAttackerAttackSectionController struct {
    beego.Controller
}

func (c *ApiCustomAttackerAttackSectionController) Get() {
    ...
    response := custom_service.ApiCustomAttackerAttackSectionService(
        user,
