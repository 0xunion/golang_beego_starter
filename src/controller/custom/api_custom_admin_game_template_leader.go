...
type ApiCustomAdminGameTemplateLeaderController struct {
    beego.Controller
}

func (c *ApiCustomAdminGameTemplateLeaderController) Get() {
    ...
    response := custom_service.ApiCustomAdminGameTemplateLeaderService(
        user,
