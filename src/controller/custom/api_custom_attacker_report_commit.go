...
type ApiCustomAttackerReportCommitController struct {
    beego.Controller
}

func (c *ApiCustomAttackerReportCommitController) Post() {
    ...
    response := custom_service.ApiCustomAttackerReportCommitService(
        user,
