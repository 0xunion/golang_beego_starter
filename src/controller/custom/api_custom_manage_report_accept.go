...
type ApiCustomManageReportAcceptController struct {
    beego.Controller
}

func (c *ApiCustomManageReportAcceptController) Post() {
    ...
    var request_params struct {
        ...
        DefenderScore int `json:"defender_score" form:"defender_score" valid:""`
    }
    ...
    response := custom_service.ApiCustomManageReportAcceptService(
        user,
