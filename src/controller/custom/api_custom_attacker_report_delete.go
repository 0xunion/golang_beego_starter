...
type ApiCustomAttackerReportDeleteController struct {
    beego.Controller
}

func (c *ApiCustomAttackerReportDeleteController) Post() {
    ...
    response := custom_service.ApiCustomAttackerReportDeleteService(
        user,
