...
type ApiCustomManageTraceReportRejectController struct {
    beego.Controller
}

func (c *ApiCustomManageTraceReportRejectController) Post() {
    ...
    response := custom_service.ApiCustomManageTraceReportRejectService(
        user,
